<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Стоматолог',
    'longtitle' => 'Стоматолог',
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1479151701,
    'editedby' => 1,
    'editedon' => 1479154480,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1479151680,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<meta name="keywords" content="Стоматолог">
...
<li>Страница два</li>
				...
				<aside>
					...
					<div class="title services">Услуги</div>
						<ul class="nav">
							<li><a href="/uslugi/stomatolog" title="Стоматолог">Стоматолог</a></li>
<li><a href="/uslugi/doktor-lor" title="Доктор ЛОР">Доктор ЛОР</a></li>
<li><a href="/uslugi/ginekolog" title="Гинеколог">Гинеколог</a></li>
<li><a href="/uslugi/xirurg" title="Хирург">Хирург</a></li>
<li><a href="/uslugi/pediatr" title="Педиатр">Педиатр</a></li>
						</ul>
					</div>
					<div class="box">
...
<li>Страница два</li>
    ...
    '[[*id:isnot=`1`:then=`<ul class="breadcrumbs">
<li><a href="#" title="">Главная</a></li>
<li><a href="#" title="">Страница один</a></li>
<li>Страница два</li>
...
<li><a href="/uslugi/pediatr" title="Педиатр">Педиатр</a></li>
    ...
    '[[~11]]' => 'speczialistyi/speczialist-2',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
    array (
      ...
      array (
        ...
        array (
          ...
          'name' => 'head',
          'description' => 'Все, что в head + wrapper',
          'editor_type' => 0,
          'category' => 2,
          'cache_type' => 0,
...
',
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'header',
          'description' => 'Шапка сайта + навигация',
          'editor_type' => 0,
          'category' => 2,
          'cache_type' => 0,
          'snippet' => '<header>
...
<li>Страница два</li>
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'aside',
          'description' => 'Левая колонка: вывод врачей + вывод меню',
          'editor_type' => 0,
          'category' => 2,
          'cache_type' => 0,
          'snippet' => '<aside>
	...
	&includeTVs=`1`
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'footer',
          'description' => 'Подвал + закрывающие теги',
          'editor_type' => 0,
          'category' => 2,
          'cache_type' => 0,
          'snippet' => '<footer>
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'seoTitle',
          'caption' => 'Title для страницы',
          'description' => 'Введите SEO title',
          'editor_type' => 0,
          'category' => 1,
          'locked' => false,
          'elements' => '',
